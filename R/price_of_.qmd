...
# データ保存
write.table(df, file = file.path(outdir, paste0("retail_price", item, "_all.csv")), sep = ",", row.names = FALSE)
...
ggsave(filename = file.path(figdir, paste0("retail_price", item, "_all", ".pdf")), plot = g, width = 8, height = 4)
...
ggsave(filename = file.path(figdir, paste0("retail_price", item, "_yearly", ".pdf")), plot = g2, width = 8, height = 4)
